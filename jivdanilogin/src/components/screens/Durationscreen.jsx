...
import { ALLERGIES_HEADER, Complaints, DURATION_HEADER } from "../../master/master/HeaderData";
...
class ComplaintsErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, errorInfo) {
    console.error("Duration Error:", error, errorInfo);
  }
    ...
    if (this.state.hasError) {
      return (
        <div className="alert alert-danger" role="alert">
          ...
          <p>We couldn't load the Duration table. Please try again later.</p>
          <button
...
const DurationScreen = () => {
  ...
  const [catId, setCatId] = useState(Categories.DURATION.catID);
  ...
  const getData = async (
    ...
    try {
      const results = await MasterApi(
        !activeCatId ? Categories.DURATION.catID : activeCatId,
        crntPage,
        searchKey,
        PerPage
      );
  ...
  //       </div>
  //       <p className="mt-2 text-muted">Loading Duration...</p>
  //     </div>
  //   );
  // }
    ...
    return (
      <div className="p-4 bg-white rounded shadow-sm">
        <div className="alert alert-warning" role="alert">
          Failed to load Duration: {error.message}
        </div>
      </div>
    );
  }
      ...
      <ComplaintsErrorBoundary>
        ...
        >
          ...
          <div
            ...
            style={{ width: "90%" }}
          >
            <h6 style={{ color: Color.primary }}>Duration</h6>
          ...
          >
            ...
            >
              <div className="" style={{ flexGrow: 1 }}>
                ...
                >
                  <TableHeader headerName={DURATION_HEADER} />
                </table>
              ...
              >
                <div className="modal-content">
                  <div className="modal-body">
                    <p>Are you sure you want to delete this Duration?</p>
                  </div>
