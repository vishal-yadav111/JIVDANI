...
import { ALLERGIES_HEADER, CNS_HEADER, Complaints } from "../../master/master/HeaderData";
...
class ComplaintsErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, errorInfo) {
    console.error("CNS Error:", error, errorInfo);
  }
    ...
    if (this.state.hasError) {
      return (
        <div className="alert alert-danger" role="alert">
          ...
          <p>We couldn't load the CNS table. Please try again later.</p>
          <button
...
const CnsScreen = () => {
  ...
  const [catId, setCatId] = useState(Categories.CNS.catID);
  ...
  const getData = async (
    ...
    try {
      const results = await MasterApi(
        !activeCatId ? Categories.CNS.catID : activeCatId,
        crntPage,
        searchKey,
        PerPage
      );
  ...
  if (loading) {
    return (
      <div className="p-4 bg-white rounded shadow-sm text-center">
        ...
        <p className="mt-2 text-muted">Loading CNS...</p>
      </div>
    );
  }
    ...
    return (
      <div className="p-4 bg-white rounded shadow-sm">
        <div className="alert alert-warning" role="alert">
          Failed to load CNS: {error.message}
        </div>
      </div>
    );
  }
      ...
      <ComplaintsErrorBoundary>
        ...
        >
          ...
          <div
            ...
            style={{ width: "90%" }}
          >
            <h6 style={{ color: Color.primary }}>CNS </h6>
            <div className="position-relative w-50">
              <input
                type="text"
                placeholder="Search CNS..."
                value={search}
          ...
          >
            ...
            >
              <div className="" style={{ flexGrow: 1 }}>
                ...
                >
                  <TableHeader headerName={CNS_HEADER} />
                </table>
              ...
              >
                <div className="modal-content">
                  <div className="modal-body">
                    <p>Are you sure you want to delete this CNS?</p>
                  </div>
