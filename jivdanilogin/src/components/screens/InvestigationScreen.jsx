...
import { ALLERGIES_HEADER, Complaints, InvestigationHeader } from "../../master/master/HeaderData";
    ...
    if (this.state.hasError) {
      return (
        <div className="alert alert-danger" role="alert">
          ...
          <p>We couldn't load the Investigation table. Please try again later.</p>
          <button
...
const InvestigationScreen = () => {
  ...
  const [catId, setCatId] = useState(Categories.INVESTIGATIONS.catID);
  ...
  const getData = async (
    ...
    try {
      const results = await MasterApi(
        !activeCatId ? Categories.INVESTIGATIONS.catID : activeCatId,
        crntPage,
        searchKey,
        PerPage
      );
  ...
  //       </div>
  //       <p className="mt-2 text-muted">Loading Investigation...</p>
  //     </div>
  //   );
  // }
      ...
      <ComplaintsErrorBoundary>
        ...
        >
          ...
          <div
            ...
            style={{ width: "90%" }}
          >
            <h6 style={{ color: Color.primary }}>Investigation</h6>
          ...
          >
            ...
            >
              <div className="" style={{ flexGrow: 1 }}>
                ...
                >
                  <TableHeader headerName={InvestigationHeader} />
                </table>
