...
class ComplaintsErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, errorInfo) {
    console.error("Whens Error:", error, errorInfo);
  }
    ...
    if (this.state.hasError) {
      return (
        <div className="alert alert-danger" role="alert">
          ...
          <p>We couldn't load the Whens table. Please try again later.</p>
          <button
...
const WhensScreen = () => {
  ...
  const [catId, setCatId] = useState(Categories.WHENS.catID);
  ...
  const getData = async (
    ...
    try {
      const results = await MasterApi(
        !activeCatId ? Categories.WHENS.catID : activeCatId,
        crntPage,
        searchKey,
        PerPage
      );
    ...
    return (
      <div className="p-4 bg-white rounded shadow-sm">
        <div className="alert alert-warning" role="alert">
          Failed to load Whens: {error.message}
        </div>
      </div>
    );
  }
      ...
      <ComplaintsErrorBoundary>
        ...
        >
          ...
          <div
            ...
            style={{ width: "90%" }}
          >
            <h6 style={{ color: Color.primary }}>Whens</h6>
            <div className="position-relative w-50">
              <input
                type="text"
                placeholder="Search Whens..."
                value={search}
          ...
          >
            ...
            >
              <div className="" style={{ flexGrow: 1 }}>
                ...
                >
                  <TableHeader headerName={Whens_header} />
                </table>
