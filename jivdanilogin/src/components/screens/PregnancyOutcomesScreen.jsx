...
import { ALLERGIES_HEADER, Complaints, PREGNANCY_OUTCOME_HEADER } from "../../master/master/HeaderData";
...
class ComplaintsErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, errorInfo) {
    console.error("Pregnancy Outcomes Error:", error, errorInfo);
  }
    ...
    if (this.state.hasError) {
      return (
        <div className="alert alert-danger" role="alert">
          ...
          <p>We couldn't load the Pregnancy Outcomes table. Please try again later.</p>
          <button
...
const PregnancyOutcomesScreen = () => {
  ...
  const [catId, setCatId] = useState(Categories.PREGNANCY_OUTCOME.catID);
  ...
  const getData = async (
    ...
    try {
      const results = await MasterApi(
        !activeCatId ? Categories.PREGNANCY_OUTCOME.catID : activeCatId,
        crntPage,
        searchKey,
        PerPage
      );
    ...
    return (
      <div className="p-4 bg-white rounded shadow-sm">
        <div className="alert alert-warning" role="alert">
          Failed to load Pregnancy Outcomes: {error.message}
        </div>
      </div>
    );
  }
      ...
      <ComplaintsErrorBoundary>
        ...
        >
          ...
          <div
            ...
            style={{ width: "90%" }}
          >
            <h6 style={{ color: Color.primary }}>Pregnancy Outcomes</h6>
            <div className="position-relative w-50">
              <input
                type="text"
                placeholder="Search Pregnancy Outcomes..."
                value={search}
          ...
          >
            ...
            >
              <div className="" style={{ flexGrow: 1 }}>
                ...
                >
                  <TableHeader headerName={PREGNANCY_OUTCOME_HEADER} />
                </table>
              ...
              >
                <div className="modal-content">
                  <div className="modal-body">
                    <p>Are you sure you want to delete this Pregnancy Outcomes?</p>
                  </div>
...
export default PregnancyOutcomesScreen;
