...
import { ALLERGIES_HEADER, Complaints, DiagnosisHeader } from "../../master/master/HeaderData";
...
class ComplaintsErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, errorInfo) {
    console.error("Diagnosis Error:", error, errorInfo);
  }
    ...
    if (this.state.hasError) {
      return (
        <div className="alert alert-danger" role="alert">
          ...
          <p>We couldn't load the Diagnosis table. Please try again later.</p>
          <button
...
const DiagnosisScreen = () => {
  ...
  const [catId, setCatId] = useState(Categories.DIAGNOSIS.catID);
  ...
  const getData = async (
    ...
    try {
      const results = await MasterApi(
        !activeCatId ? Categories.DIAGNOSIS.catID : activeCatId,
        crntPage,
        searchKey,
        PerPage
      );
  ...
  //       </div>
  //       <p className="mt-2 text-muted">Loading Diagnosis...</p>
  //     </div>
  //   );
  // }
    ...
    return (
      <div className="p-4 bg-white rounded shadow-sm">
        <div className="alert alert-warning" role="alert">
          Failed to load Diagnosis: {error.message}
        </div>
      </div>
    );
  }
      ...
      <ComplaintsErrorBoundary>
        ...
        >
          ...
          <div
            ...
            style={{ width: "90%" }}
          >
            <h6 style={{ color: Color.primary }}>Diagnosis</h6>
          ...
          >
            ...
            >
              <div className="" style={{ flexGrow: 1 }}>
                ...
                >
                  <TableHeader headerName={DiagnosisHeader} />
                </table>
