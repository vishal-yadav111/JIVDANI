...
import { ALLERGIES_HEADER, Complaints, Lab_Test_Header } from "../../master/master/HeaderData";
...
class ComplaintsErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, errorInfo) {
    console.error("Lab Test And Imaging Error:", error, errorInfo);
  }
    ...
    if (this.state.hasError) {
      return (
        <div className="alert alert-danger" role="alert">
          ...
          <p>We couldn't load the Lab Test And Imaging table. Please try again later.</p>
          <button
  ...
  const getData = async (
    ...
    try {
      const results = await MasterApi(
        !activeCatId ? Categories.LAB_TESTS_AND_IMAGING.catID : activeCatId,
        crntPage,
        searchKey,
        PerPage
      );
    ...
    return (
      <div className="p-4 bg-white rounded shadow-sm">
        <div className="alert alert-warning" role="alert">
          Failed to load Lab Test And Imaging: {error.message}
        </div>
      </div>
    );
  }
      ...
      <ComplaintsErrorBoundary>
        ...
        >
          ...
          <div
            ...
            style={{ width: "90%" }}
          >
            <h6 style={{ color: Color.primary }}>Lab Test And Imaging Analysis</h6>
            <div className="position-relative w-50">
              <input
                type="text"
                placeholder="Search Lab Test And Imaging..."
                value={search}
          ...
          >
            ...
            >
              <div className="" style={{ flexGrow: 1 }}>
                ...
                >
                  <TableHeader headerName={Lab_Test_Header} />
                </table>
...
export default LabTestImagingScreen;
