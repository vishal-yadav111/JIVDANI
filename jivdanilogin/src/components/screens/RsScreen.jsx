...
import { ALLERGIES_HEADER, Complaints, RS_HEADER } from "../../master/master/HeaderData";
...
class ComplaintsErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, errorInfo) {
    console.error("RS Error:", error, errorInfo);
  }
    ...
    if (this.state.hasError) {
      return (
        <div className="alert alert-danger" role="alert">
          ...
          <p>We couldn't load the RS table. Please try again later.</p>
          <button
...
const RaScreen = () => {
  ...
  const [catId, setCatId] = useState(Categories.RS.catID);
  ...
  const getData = async (
    ...
    try {
      const results = await MasterApi(
        !activeCatId ? Categories.RS.catID : activeCatId,
        crntPage,
        searchKey,
        PerPage
      );
  ...
  if (loading) {
    return (
      <div className="p-4 bg-white rounded shadow-sm text-center">
        ...
        <p className="mt-2 text-muted">Loading RS...</p>
      </div>
    );
  }
    ...
    return (
      <div className="p-4 bg-white rounded shadow-sm">
        <div className="alert alert-warning" role="alert">
          Failed to load RS: {error.message}
        </div>
      </div>
    );
  }
      ...
      <ComplaintsErrorBoundary>
        ...
        >
          ...
          <div
            ...
            style={{ width: "90%" }}
          >
            <h6 style={{ color: Color.primary }}>RS</h6>
          ...
          >
            ...
            >
              <div className="" style={{ flexGrow: 1 }}>
                ...
                >
                  <TableHeader headerName={RS_HEADER} />
                </table>
              ...
              >
                <div className="modal-content">
                  <div className="modal-body">
                    <p>Are you sure you want to delete this RS?</p>
                  </div>
