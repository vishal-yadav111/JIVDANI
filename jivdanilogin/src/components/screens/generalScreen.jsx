...
import { ALLERGIES_HEADER, Complaints, generalExaminations } from "../../master/master/HeaderData";
    ...
    if (this.state.hasError) {
      return (
        <div className="alert alert-danger" role="alert">
          ...
          <p>We couldn't load the General table. Please try again later.</p>
          <button
...
const GeneralScreen = () => {
  ...
  const [catId, setCatId] = useState(Categories.GENERAL.catID);
  ...
  const getData = async (
    ...
    try {
      const results = await MasterApi(
        !activeCatId ? Categories.GENERAL.catID : activeCatId,
        crntPage,
        searchKey,
        PerPage
      );
  ...
  //       </div>
  //       <p className="mt-2 text-muted">Loading General...</p>
  //     </div>
  //   );
  // }
  ...
  //         Failed to load General: {error.message}
  //       </div>
  //     </div>
  //   );
  // }
      ...
      <ComplaintsErrorBoundary>
        ...
        >
          ...
          <div
            ...
            style={{ width: "90%" }}
          >
            <h6 style={{ color: Color.primary }}>General</h6>
          ...
          >
            ...
            >
              <div className="" style={{ flexGrow: 1 }}>
                ...
                >
                  <TableHeader headerName={generalExaminations} />
                </table>
