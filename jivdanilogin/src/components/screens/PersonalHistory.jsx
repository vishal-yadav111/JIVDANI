...
import { ALLERGIES_HEADER, Complaints, PERSONAL_HISTORY_HEADER } from "../../master/master/HeaderData";
...
class ComplaintsErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, errorInfo) {
    console.error("Personal History Table Error:", error, errorInfo);
  }
    ...
    if (this.state.hasError) {
      return (
        <div className="alert alert-danger" role="alert">
          ...
          <p>We couldn't load the Personal History table. Please try again later.</p>
          <button
...
const PersonalHistory = () => {
  ...
  const [catId, setCatId] = useState(Categories.PERSONAL_HISTORY.catID);
  ...
  const getData = async (
    ...
    try {
      const results = await MasterApi(
        !activeCatId ? Categories.PERSONAL_HISTORY.catID : activeCatId,
        crntPage,
        searchKey,
        PerPage
      );
  ...
  //       </div>
  //       <p className="mt-2 text-muted">Loading Personal History...</p>
  //     </div>
  //   );
  // }
    ...
    return (
      <div className="p-4 bg-white rounded shadow-sm">
        <div className="alert alert-warning" role="alert">
          Failed to load Personal History: {error.message}
        </div>
      </div>
    );
  }
      ...
      <ComplaintsErrorBoundary>
        ...
        >
          ...
          <div
            ...
            style={{ width: "90%" }}
          >
            <h6 style={{ color: Color.primary }}>Personal History</h6>
            <div className="position-relative w-50">
              <input
                type="text"
                placeholder="Search Personal History..."
                value={search}
          ...
          >
            ...
            >
              <div className="" style={{ flexGrow: 1 }}>
                ...
                >
                  <TableHeader headerName={PERSONAL_HISTORY_HEADER} />
                </table>
              ...
              >
                <div className="modal-content">
                  <div className="modal-body">
                    <p>Are you sure you want to delete this Personal History?</p>
                  </div>
